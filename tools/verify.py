...
def verification_commands(model_exports_only: bool) -> list[list[str]]:
    return [
        ...
        ['cargo', 'test', '--release', '--locked', '--offline', '--manifest-path', 'crates/spars-model/Cargo.toml', '--', '--include-ignored'],
        ['cargo', 'build', '--release', '--locked', '--offline', '--manifest-path', 'crates/spars-model/Cargo.toml'],
