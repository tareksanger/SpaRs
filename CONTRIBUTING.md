...
Squash-merge contributions and use the validated PR title as the squash commit title. Release Please reads those commits to prepare versions and changelogs. Explain breaking changes and migration steps in the PR body and review their release notes before merging the release PR. See [releasing](docs/RELEASING.md) for versioning and automation setup.
